...
class CourseController extends Controller
{
    ...
    public function show(Course $course)
    {
        ...
        $val = $course->where('courses.id', $course->id)->join('modalities', 'modalities.id', '=', 'courses.modality_id')
            ...
            ->select('courses.*', 'modalities.name as modalitiy_name', 'modalities.name_en as modalitiy_name_en', 'degrees.name as degrees_name', 'degrees.name_en as degrees_name_en', 'responsables.surname as responsables_surname', 'teams.surname as teams_surname','responsables.photo as responsables_photo', 'teams.photo as teams_photo', 'responsables.statut as responsables_statut', 'teams.statut as teams_statut','responsables.statut_en as responsables_statut_en', 'teams.statut_en as teams_statut_en','responsables.poste_en as responsables_poste_en', 'teams.poste_en as teams_poste_en','responsables.poste as responsables_poste', 'teams.poste as teams_poste','responsables.etablissement as responsables_etablissement', 'teams.etablissement as teams_etablissement','responsables.country as responsables_country', 'teams.country as teams_country','responsables.phone as responsables_phone', 'teams.phone as teams_phone','responsables.email as responsables_email', 'teams.email as teams_email','languages.name as languages_name', 'modes.name as modes_name', 'responsables.name as responsables_name', 'teams.name as teams_name')
            ->get();
    ...
    public function showByName(string $res)
    {
        ...
        $val = DB::table('courses')->where('courses.name', $res)->join('modalities', 'modalities.id', '=', 'courses.modality_id')
            ...
            ->leftjoin('responsables', 'responsables.id', '=', 'courses.responsable_id')
            ->leftjoin('teams', 'teams.id', '=', 'courses.team_id')
            ->select('courses.*', 'modalities.name as modalitiy_name', 'modalities.name_en as modalitiy_name_en', 'degrees.name as degrees_name', 'degrees.name_en as degrees_name_en', 'responsables.surname as responsables_surname', 'teams.surname as teams_surname','responsables.photo as responsables_photo', 'teams.photo as teams_photo', 'responsables.statut as responsables_statut', 'teams.statut as teams_statut','responsables.statut_en as responsables_statut_en', 'teams.statut_en as teams_statut_en','responsables.poste_en as responsables_poste_en', 'teams.poste_en as teams_poste_en','responsables.poste as responsables_poste', 'teams.poste as teams_poste','responsables.etablissement as responsables_etablissement', 'teams.etablissement as teams_etablissement','responsables.country as responsables_country', 'teams.country as teams_country','responsables.phone as responsables_phone', 'teams.phone as teams_phone','responsables.email as responsables_email', 'teams.phone as teams_email','languages.name as languages_name', 'modes.name as modes_name', 'responsables.name as responsables_name', 'teams.name as teams_name')
            ->get();
