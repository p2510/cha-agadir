...
<h2>Subject: acknowledgement of interest -: {{ $course_name }} - {{ $degree }}</h2>
<br>

<h3>Dear {{ $name }}</h3>
<br>
<div>
    We sincerely appreciate your interest in our institution and specifically, our “[Program
    Name] - [Cycle]” program. It's always exciting to engage with individuals who share
    our passion for learning and growth. {{ $course_name }} - {{ $degree }} »
    :
</div>
<br>
