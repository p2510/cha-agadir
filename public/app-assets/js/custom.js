    ...
    THEMEMASCOT.header = {
        ...
        TM_scroolToTop: function() {
            if ($window.scrollTop() > 200) {
                $('.header-mobile-version').fadeIn();
            } else {
                $('.header-mobile-version').fadeOut();
            }
        ...
        TM_navLocalScorll: function() {
            var data_offset = -60;
            var $local_scroll = $("#menuzord .menuzord-menu, #menuzord-right .menuzord-menu, #menuzord-mobile-version .menuzord-menu");
        ...
        TM_menuzord: function() {
            ...
            var $menuzord_right = $("#menuzord-mobile-version");
            if( $menuzord_right.length > 0 ) {
                $menuzord_right.menuzord({
                    align: "right",
                    effect: "slide",
